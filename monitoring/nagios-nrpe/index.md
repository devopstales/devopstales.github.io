...
url: https://devopstales.github.io/monitoring/nagios-nrpe/
date: 2019-05-06
...
![Example image](/img/include/nrpe.webp)
...
```
# createcustom commands for nrpe
...
```
nano /etc/nagios/conf.d/nrpe-test.cfg
        define host{
        use                    generic-host
