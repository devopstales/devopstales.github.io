---
title: Grafana Loki
url: https://devopstales.github.io/monitoring/grafana-loki/
date: 2019-06-22
keywords: grafana, dashboard, loki, kubernetes, logging
---



Loki is a Prometheus-inspired logging service for cloud native infrastructure.
It’s similar to well-known ELK stack but more simple use and is intended to be used mostly Kubernetes.
<!--more-->
