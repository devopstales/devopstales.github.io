---
title: Foreman openidc SSO with keycloak
url: https://devopstales.github.io/sso/foreman-sso/
date: 2020-05-15
keywords: Keycloak, Katello, Foreman, SSO, OIDC, oauth2
---
...
![Example image](/img/include/foreman-sso-1.webp)<br/>
![Example image](/img/include/foreman-sso-2.webp)<br/>
...
Create an user groupe in foreman called `foreman-admin` and map with the external group called `foreman-admin`.
![Example image](/img/include/foreman-sso-3.webp)<br/>
![Example image](/img/include/foreman-sso-4.webp)<br/>
![Example image](/img/include/foreman-sso-5.webp)<br/>
