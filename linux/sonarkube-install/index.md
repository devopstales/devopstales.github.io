...
url: https://devopstales.github.io/linux/sonarkube-install/
date: 2019-05-30
---


Sonarqube Repository OSS is an artifact repository with universal support for popular formats.
<!--more-->
...
### Create sistemd serice for Sonarqube
```
echo '[Unit]
Description=Sonar
