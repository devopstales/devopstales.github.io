---
title: Kubernetes Single Sign-on with Pinniped OpenID Connect
url: https://devopstales.github.io/kubernetes/k8s-pinniped/
date: 2021-12-29
keywords: VMware Tanzu, Pinniped, openid, ldap, k8s, kubernetes
---
...
![Pinniped Architecture](/img/include/pinniped01.svg)
...
> The `supervisor.k8s.intra` domain must be resolwable from the pinniped-concierge.
> You can add `supervisor.k8s.intra` as like hists file to the coredns [like this](https://devopstales.github.io/home/k8s-custom-host/).
...
Or find the appropriate binary for your platform from the [latest release](https://github.com/vmware-tanzu/pinniped/releases) the put the command-line tool somewhere on your `$PATH`.
