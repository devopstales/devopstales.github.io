---
title: Secure k3s with gVisor
url: https://devopstales.github.io/kubernetes/k3s-gvisor/
date: 2021-04-30
keywords: kubernetes deployment, kubernetes vs docker, Kubernetes Secuity, best Practices, k3s, gVisor
---
...
In  [previous pos](https://devopstales.github.io/kubernetes/k3s-etcd-kube-vip/) I showd you how to install a k3s Cluster. Now we modify the configuration of the containerd to use different low level container runtime.
