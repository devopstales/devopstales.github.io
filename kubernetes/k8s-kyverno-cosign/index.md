---
title: Image Signature Verification with Kyverno
url: https://devopstales.github.io/kubernetes/k8s-kyverno-cosign/
date: 2021-08-18
keywords: kubernetes deployment, kubernetes vs docker, Kyverno, mutating webhook, Admission Controller, Cosign
---
...
![Notice how the signature tag below corresponds to the sha256 digest of the image tag ‘latest’ above.](/img/include/Cosign.webp)
...
### Installing Cosign
It’s a golang project, so it’s fairly easy to get started, there’s a single binary available from their [release pag](https://github.com/sigstore/cosign/releases) and it has been signed by them.
...
---
* [Kyverno Blog post](https://nirmata.com/2021/08/12/kubernetes-supply-chain-policy-management-with-cosign-and-kyverno/)
