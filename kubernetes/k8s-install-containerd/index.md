...
url: https://devopstales.github.io/kubernetes/k8s-install-containerd/
date: 2021-11-09
...
Environment="KUBELET_KUBEADM_ARGS=--node-ip=192.168.1.41 --container-runtime=remote --container-runtime-endpoint=/run/containerd/containerd.sock --cgroup-driver=systemd"
```
