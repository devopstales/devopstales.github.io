---
title: Containers and Container runtimes for Beginners
url: https://devopstales.github.io/kubernetes/container-runtimes/
date: 2022-04-22
keywords: kubernetes deployment, Containerd, CRI-O, Podman, containerd-shim, runc, runv
---
...
![vm vs cotainer](/img/include/VM-container.webp)
...
"While most of the tools used in the Linux containers ecosystem are written in Go, I believe C is a better fit for a lower level tool like a container runtime. runc, the most used implementation of the OCI runtime specs written in Go, re-execs itself and use a module written in C for setting up the environment before the container process starts." (Source: [crun GitHub page](https://github.com/containers/crun#why-another-implementation) )
...
![Example image](/img/include/conatinerd.webp)
...
CRI-O supports OCI container images and can pull from any container registry. It is a lightweight alternative to using Docker, Moby or rkt as the runtime for Kubernetes. (Source: [CRI-O Website](https://cri-o.io/) )
...
![PouchContainer](/img/include/pouchcontainer-arch.webp)
...
![Podman](/img/include/porownanie.webp)
...
![Containerd](/img/include/docker_oci.webp)
...
gVisor includes an Open Container Initiative (OCI) compatible Low-Level Container Runtime called `runsc` that makes it easy to work with existing container tooling. The `runsc` runtime integrates with Docker, containerd and Kubernetes, making it simple to run sandboxed containers.
