---
title: How to create Users in Kubernetes the right way?
url: https://devopstales.github.io/kubernetes/k8s-user-accounts/
date: 2022-03-22
keywords: Kubernetes, User, RBAC
---
...
### Conclusion
As we can see creating certificate for all the users is a hard task for the administratos if we hawe many users. A better solution to use an sso based authentication proxy like my [Kubectl OpenID Connect](/kubernetes/kube-openid-connect-1.0/).
