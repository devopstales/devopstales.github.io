---
title: Kubernetes Rolling Update Configuration
url: https://devopstales.github.io/kubernetes/k8s-rolling-pods-config-changes/
date: 2023-05-25
keywords: Kubernetes Scheduler, Deployment controller, Rolling Update, Rolling Upgrade
---
...
![Deployment Overview](/img/include/deployment_overview01.webp)
...
For a working rolling update the first precondition in a Deployment is the `replicas`. To seamlessly upgrade between versions you need multiple running pods. 

The nex important configuration is the update strategy in `strategy.type`. it can be *RollingUpdate* (New pods are added gradually, and old pods are terminated gradually) or *Recreate* (All old pods are terminated before any new pods are added).
...
![Rolling Upgrades](/img/include/deployment_overview02.webp)
