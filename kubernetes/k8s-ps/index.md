...
url: https://devopstales.github.io/kubernetes/k8s-ps/
date: 2022-08-23
...
Pod Security Admission use profiles based on [Pod Security Standards](https://kubernetes.io/docs/concepts/security/pod-security-standards/). These standards define three different policy levels:
...
* pod-security.kubernetes.io/<MODE>: <LEVEL> (required to enable pod security Admission)
...
You ken use Kyverno to autamate the creation of the labels at namespace. The usage Kyverno is out of the scope of this post but if you want to know more about about this topic check [my other post](https://devopstales.github.io/kubernetes/k8s-kyverno-cosign/).
...
The enableing of the audit-policy function is out of the scope of this post but if you want to know more about about this topic check [my other post](https://devopstales.github.io/kubernetes/k8s-falco/).

### PSP migrations
If you're already using PSP, I created a guide and [published the steps to migrate off of PSP](/kubernetes/k8s-migrate-from-psp/).
