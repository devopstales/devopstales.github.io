---
title: Flagger NGINX Canary Deployments
url: https://devopstales.github.io/kubernetes/flagger-nginx-canary-deployments/
date: 2022-03-15
keywords: kubernetes deployment, gitops, flagger
---
...
![appinfo](/img/include/flagger-nginx01.webp)
...
![appinfo](/img/include/flagger-nginx02.webp)
...
![appinfo](/img/include/flagger-nginx03.webp)
...
You can configure Flagger to send its logs to your Slack workspace. To use Slack integration, you’ll need to have an [incoming webhook](https://api.slack.com/messaging/webhooks) on Slack for your workspace.

To do so, first log in to Slack and navigate to the [app creation](https://api.slack.com/apps?new_app=1) page. Pick a name that you’ll recognize, select the desired workspace, and click `Create App`.

You’ll be redirected to the settings page for the new app. Click on `Incoming Webhooks` on the left navigation bar.

![slack webhook](/img/include/flagger-nginx04.webp)

Enable webhooks by flipping the switch button next to the title `Activate Incoming Webhooks`.

![slack webhook](/img/include/flagger-nginx05.webp)
...
![slack messages](/img/include/flagger-nginx06.webp)

When this release deploys, you’ll see a success message:

![slack messages](/img/include/flagger-nginx07.webp)
...
![slack messages](/img/include/flagger-nginx08.webp)
