---
title: Publish Kubernetes Operator to OperatorHub
url: https://devopstales.github.io/kubernetes/oml/
date: 2021-12-21
keywords: ansible, openshift 3.11, openshift 4, openshift container platform, rad hat openshift, rad hat, configuration management
---
...
* [operator-registry-tools](https://github.com/operator-framework/operator-registry/releases)
...
You must place the `CustomResourceDefinitions` to the `manifests` folder andy any other object like `service` what you want to deploy by the `Operator Framework`. If you created your `` you can test with OperatorHub's [Operator Preview](https://operatorhub.io/preview) page.
...
To publish your bundled operator you need to create a pull requuest to the [operatorhub  community-operators](https://github.com/k8s-operatorhub/community-operators) repo or [RedHat Opeshift community-operators](https://github.com/redhat-openshift-ecosystem/community-operators-prod) repo.
