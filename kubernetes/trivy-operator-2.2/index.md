---
title: trivy-operator 2.2: Patch release for Admisssion controller
url: https://devopstales.github.io/kubernetes/trivy-operator-2.2/
date: 2021-12-27
...
* Now the Admission Controller Function generates it's own self signed certificate for the `ValidatingWebhook`
